...
namespace Weno5Coeff {
  double a1[3] = {
    ...
    RAT1*RAT1*(1 + 2*RAT1 + 2*RAT1*RAT1)/((1 + RAT1)*(1 + RAT1 + RAT1*RAT1)),
    1/(1 + RAT1 + RAT1*RAT1)
    };
  ...
  double a3[3] = {
    (3 + 4*RAT1 + 3*RAT1*RAT1 + RAT1*RAT1*RAT1)/((1 + RAT1)*(1 + RAT1 + RAT1*RAT1)),
    -(1 + 3*RAT1 + 2*RAT1*RAT1 + RAT1*RAT1*RAT1)/(RAT1*RAT1*(1 + RAT1)*(1 + RAT1 + RAT1*RAT1)),
    1/(RAT1*RAT1*RAT1*(1 + RAT1 + RAT1*RAT1))
    };

  double wght[3] = {
    (RAT1*RAT1*RAT1*RAT1*(1 + RAT1 + RAT1*RAT1))/((1 + RAT1*RAT1)*(1 + RAT1 + RAT1*RAT1 + RAT1*RAT1*RAT1 + RAT1*RAT1*RAT1*RAT1)),
    (RAT1*(1 + RAT1)*(1 + RAT1 + RAT1*RAT1))/((1 + RAT1*RAT1)*(1 + RAT1 + RAT1*RAT1 + RAT1*RAT1*RAT1 + RAT1*RAT1*RAT1*RAT1)),
    1/((1 + RAT1*RAT1)*(1 + RAT1 + RAT1*RAT1 + RAT1*RAT1*RAT1 + RAT1*RAT1*RAT1*RAT1))
    };

  double beta1[3][6] = {
    {4./3., -19./3., 11./3., 25./3., -31./3., 10./3.},
    {35./3., -132./3., 59./3., 124./3., -104./3., 6.},
    {1592./36., -4631./36., 1483./36., 2993./36., -1463./36., 62./36.}
    };
  ...
  double beta3[3][6] = {
    ...
    {278./36., -2711./36., 2191./36., 4481./36., -6215./36., 2012./36.}
    };

  double c1[5] = {-3./60., 27./60., 47./60., -13./60., 2./60.};
  double c2[5] = {-33./120., 147./120., -133./120., 107./120., -28./120.};
  double c3[5] = {-387./720., 513./720., 673./720., -1487./720., 628./720.};
...
inline Real interp_weno5(Real phim2, Real phim1, Real phi, Real phip1, Real phip2) {
  ...
  Real b1 = 0, b2 = 0, b3 = 0;
  Real eps = RAT1 - 1.;
  Real pp1[6] = {phim2*phim2, phim2*phim1, phim2*phi, phim1*phim1, phim1*phi, phi*phi};
  Real pp2[6] = {phim1*phim1, phim1*phi, phim1*phip1, phi*phi, phi*phip1, phip1*phip1};
  Real pp3[6] = {phi*phi, phi*phip1, phi*phip2, phip1*phip1, phip1*phip2, phip2*phip2};
