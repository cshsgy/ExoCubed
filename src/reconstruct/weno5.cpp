...
void FaceReconstruct::Weno5X1(const int k, const int j, const int il, const int iu,
...
void FaceReconstruct::Weno5X2(const int k, const int j, const int il, const int iu,
  const AthenaArray<Real> &w, const AthenaArray<Real> &bcc,
  AthenaArray<Real> &wl, AthenaArray<Real> &wr)
{
  for (int n=0; n<=NumVapors; ++n) {
...
void FaceReconstruct::Weno5X3(const int k, const int j, const int il, const int iu,
  const AthenaArray<Real> &w, const AthenaArray<Real> &bcc,
  AthenaArray<Real> &wl, AthenaArray<Real> &wr)
{
  for (int n=0; n<=NumVapors; ++n) {
